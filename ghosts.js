class Ghosts {
    ...
    addNeighbors(poped, mp) {
        ...
        if(poped.x - 1 >= 0 && poped.x - 1 < numOfRows &&
        ...
        if(poped.y - 1 >= 0 && poped.y - 1 < numOfRows &&
    ...
    draw() {
        ...
        canvasContext.drawImage(
            ghostFrames,
            this.imageX, this.imageY, this.imageHeight, this.imageWidth, this.x, this.y, this.width, this.height
        );
